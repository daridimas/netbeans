 ...
 */
package com.stripbandunk.swing.imagetransitioncomponent;

import com.stripbandunk.jglasspane.helper.GraphicHelper;
import com.stripbandunk.swing.transitioncomponent.*;
...
import com.stripbandunk.jglasspane.transition.image.creator.UrlImageCreator;
...
public class FormUtama extends javax.swing.JFrame {
    ...
    public FormUtama() {
        ...
        // imageTransitionComponent1.setImageCreator(new UrlImageCreator(getClass().getResource("/com/stripbandunk/swing/imagetransitioncomponent/Wallpaper.png")));
    ...
    private void jButtonBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarangActionPerformed
        ...
        FadeImageTransition transition = new FadeImageTransition(); //panggil transisi
    ...
    private void jButtonKategoriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonKategoriActionPerformed
        // Efek transisi sebelum muncul
        SplitHorizontalInImageTransition transition = new SplitHorizontalInImageTransition(); //panggil transisi
        transition.setCoordinate(GraphicHelper.getLocation(jPanel1, jGlassPane1));
    ...
    private void jButtonPenjualanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPenjualanActionPerformed
        // Efek transisi sebelum muncul
        FadeRotateImageTransition transition = new FadeRotateImageTransition(); //panggil transisi
        transition.setCoordinate(GraphicHelper.getLocation(jPanel1, jGlassPane1));
