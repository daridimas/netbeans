...
public class FormUtama extends javax.swing.JFrame {
    ...
    public FormUtama() {
        ...
        jTextFieldNama.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                jTextFieldNama.setBackground(Color.YELLOW);
            }

            @Override
            public void focusLost(FocusEvent e) {
                jTextFieldNama.setBackground(Color.WHITE);
            }
        
    });
        
        jPasswordFieldKataSandi.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                jPasswordFieldKataSandi.setBackground(Color.YELLOW);
            }

            @Override
            public void focusLost(FocusEvent e) {
                jPasswordFieldKataSandi.setBackground(Color.WHITE);
            }
        
    });
        
        jTextAreaKeterangan.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                jTextAreaKeterangan.setBackground(Color.YELLOW);
            }

            @Override
            public void focusLost(FocusEvent e) {
                jTextAreaKeterangan.setBackground(Color.WHITE);
            }
