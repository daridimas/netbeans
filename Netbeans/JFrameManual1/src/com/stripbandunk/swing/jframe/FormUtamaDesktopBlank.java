 ...
 * @author dimas
 */
public class FormUtamaDesktopBlank extends javax.swing.JFrame {

    /**
     * Creates new form FormUtamaDesktopBlank
     */
    public FormUtamaDesktopBlank() {
        initComponents();
    }
    ...
    private void jInternalFrame1InternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_jInternalFrame1InternalFrameIconified
        ...
        System.out.println("Internal Frame di Minimize");
    ...
    private void jInternalFrame1InternalFrameClosing(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_jInternalFrame1InternalFrameClosing
        // TODO add your handling code here:
        int hasil = JOptionPane.showConfirmDialog(this, "Anda yakin akan menutup?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUtamaDesktopBlank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUtamaDesktopBlank().setVisible(true);
            }
        });
    }
