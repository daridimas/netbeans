 ...
 * @author dimas
 */
public class FormUtamaBlankUntukInputAngka extends javax.swing.JFrame {

    /**
     * Creates new form FormUtamaBlank
     */
    public FormUtamaBlankUntukInputAngka() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUtamaBlankUntukInputAngka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUtamaBlankUntukInputAngka().setVisible(true);
            }
        });
    }
