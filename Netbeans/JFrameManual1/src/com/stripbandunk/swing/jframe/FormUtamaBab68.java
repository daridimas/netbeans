 ...
 * @author dimas
 */
public class FormUtamaBab68 extends javax.swing.JFrame {

    /**
     * Creates new form FormUtamaBlank
     */
    public FormUtamaBab68() {
        initComponents();
    }
    ...
    private void jButtonAngkaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAngkaActionPerformed
       ...
       Long data = (Long) jFormattedTextFieldAngka.getValue();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUtamaBab68.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormUtamaBab68().setVisible(true);
            }
        });
    }
